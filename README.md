...
[![Tests](https://img.shields.io/badge/tests-1201%20passing-brightgreen)](https://github.com/Mnehmos/mnehmos.nls.lang)
...
**1,201 tests passing** across three operating systems and two Python versions, including a cross-target conformance suite that executes compiled modules on both backends. See [GitHub Issues](https://github.com/Mnehmos/mnehmos.nls.lang/issues) for the roadmap.
