...
def emit_python(
    ...
    mode: str = "mock",
    validate: bool = True,
    scaffold_anlus: Optional[set[str]] = None,
) -> str:
    """
    ...
    Args:
        ...
        scaffold_anlus: ANLU ids with unresolved executable content; when
            provided and non-empty the artifact docstring is marked as an
            incomplete scaffold so it cannot be mistaken for verified output
