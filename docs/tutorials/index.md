...
Learn NLS through practical, hands-on examples. Each tutorial builds on concepts from the previous ones.

## Learning Path

<div class="grid cards" markdown>

-   :material-numeric-1-circle: **[Your First Module](first-module.md)**
...
- [ ] A code editor (VS Code recommended with NLS extension)
...
2. **Concepts** — New ideas introduced
3. **Step-by-step** — Guided implementation
4. **Exercises** — Practice challenges
