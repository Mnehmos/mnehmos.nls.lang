...
def generate_lockfile(nl_file: NLFile, generated_code: str, output_path: str, llm_backend: str) -> Lockfile:
    """
...
def verify_lockfile(lockfile: Lockfile, nl_file: NLFile) -> list:
    """
